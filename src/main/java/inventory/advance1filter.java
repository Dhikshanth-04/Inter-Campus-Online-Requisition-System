...
@RestController
@RequestMapping("/inventory/advanced") // changed path to avoid conflict
public class advance1filter {
    ...
    // ================= Filter Inventory =================
    @GetMapping("/filter") // unique endpoint
    ...
    public List<String> getBuyers() {
        return getDistinctColumnValues("buyer");
    }

    @GetMapping("/departments")
    public List<String> getDepartments() {
        return getDistinctColumnValues("department");
    }

    @GetMapping("/institutions")
    public List<String> getInstitutions() {
        return getDistinctColumnValues("institution");
    }

    @GetMapping("/stocks")
    public List<String> getStocks() {
        return getDistinctColumnValues("stock_name");
    }

    // ================= Helper Method =================
    private List<String> getDistinctColumnValues(String column) {

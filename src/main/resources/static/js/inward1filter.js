document.addEventListener("DOMContentLoaded", () => {
  ...
  const specificDateInput = document.getElementById("specific_date"); // ✅ new field
  ...
  function getCurrentFilters() {
    ...
    return {
      ...
      specific_date: urlParams.get('specific_date') || '' // ✅ new
    };
  }
  ...
  async function loadDropdowns(currentFilters) {
    try {
      ...
      // ✅ Restore specific date if present
      if (currentFilters.specific_date) specificDateInput.value = currentFilters.specific_date;
    } catch (err) {
  ...
  function generateFilterText() {
    ...
    if (specificDateInput.value) {
      filters.push(`Specific Date: ${specificDateInput.value}`);
    } else {
  ...
  async function loadInventory() {
    try {
      ...
      // ✅ Prefer specific date over range
      if (specificDateInput.value) {
        params.append('specific_date', specificDateInput.value);
      } else {
